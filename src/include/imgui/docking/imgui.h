...
namespace ImGui
{
    ...
    // - If you want to use InputText() with own_std::string or any custom dynamic string type, see misc/cpp/imgui_stdlib.h and comments in imgui_demo.cpp.
