...
//#define ON_PARENT
  ...
  if (pid == 0) {
    ...
    outsiders["pthread_mutex_init"]         = (u64)pthread_mutex_init;
    outsiders["pthread_mutex_lock"]         = (u64)pthread_mutex_lock;
    outsiders["pthread_mutex_unlock"]       = (u64)pthread_mutex_unlock;
    outsiders["pthread_mutex_trylock"]      = (u64)pthread_mutex_trylock;
